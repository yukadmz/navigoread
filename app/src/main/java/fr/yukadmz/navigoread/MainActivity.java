...
public class MainActivity extends ActionBarActivity {
    ...
    public static final String dTag = "NavigoRead";
    ...
    private void checkNfc() {
        ...
        if (!mNfcAdapter.isEnabled()) {
            ...
            mTextView.setText("Présentez un passe Navigo\n");
            listAdapter.add("Présentez un passe Navigo...");
        }
    }
    ...
    private String save_dump_file() throws Exception {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String path = preferences.getString("dumps_location", Environment.getExternalStorageDirectory().getPath() + "/NavigoRead/");
